...
public class IndicatorView extends View implements ViewPager.OnPageChangeListener {
    ...
    private void getAttr(Context context, AttributeSet attrs) {
        ...
        mRadius = (int) typedArray.getDimensionPixelSize(R.styleable.IndicatorView_indicatorRadius, DisplayUtils.dpToPx(6));
        mStrokeWidth = (int) typedArray.getDimensionPixelSize(R.styleable.IndicatorView_indicatorBorderWidth, DisplayUtils.dpToPx(2));
        mSpace = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_indicatorSpace, DisplayUtils.dpToPx(5));
        // color
        mTextColor = typedArray.getColor(R.styleable.IndicatorView_indicatorTextColor, Color.BLACK);
        ...
        mIsEnableClickSwitch = typedArray.getBoolean(R.styleable.IndicatorView_enableIndicatorSwitch, false);
        int fillMode = typedArray.getInt(R.styleable.IndicatorView_fill_mode, 2);
        if (fillMode == 0) {
