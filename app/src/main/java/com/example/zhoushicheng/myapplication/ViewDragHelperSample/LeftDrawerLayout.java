...
public class LeftDrawerLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(widthSize, hegithSize);

        View leftMeneView = getChildAt(1);
        MarginLayoutParams lp = (MarginLayoutParams) leftMeneView.getLayoutParams();
        ...
        leftMeneView.measure(drawerWidthSpec, drawerHeightSpec);

        View contentView = getChildAt(0);
        lp = (MarginLayoutParams) contentView.getLayoutParams();
        final int contentWidthSpec = MeasureSpec.makeMeasureSpec(widthSize - lp.leftMargin - lp.rightMargin, MeasureSpec.EXACTLY);
        final int contentHeightSpec = MeasureSpec.makeMeasureSpec(widthSize - lp.topMargin - lp.bottomMargin, MeasureSpec.EXACTLY);

        contentView.measure(contentWidthSpec, contentHeightSpec);

        mLeftMenuView = leftMeneView;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        menuView.layout(childLeft, lp.topMargin, childLeft + menuWidth, lp.topMargin + contentView.getMeasuredHeight());
    }
