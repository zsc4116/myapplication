...
/**
 * Created by zhoushicheng on 2018/6/11.
 */
...
public class RatingStarView extends View {
    ...
    public RatingStarView(Context mContext, AttributeSet attrs) {
        super(mContext, attrs);
        init(mContext, attrs);
    }

    public RatingStarView(Context mContext, AttributeSet attrs, int defStyleAttr) {
